...
# variants -> 4 GRPO variants) for: Qwen/Qwen2.5-Math-7B
#
...
#   bash run_03_Qwen_Qwen2_5-Math-7B.sh 60 500
#
# Run from the repository root:
#   bash run_03_Qwen_Qwen2_5-Math-7B.sh
set -euo pipefail
cd "$(dirname "$0")"   # repository root
bash run_full_experiment.sh "Qwen/Qwen2.5-Math-7B" "${1:-full}" "${2:-full}"
