...
# variants -> 4 GRPO variants) for: Qwen/Qwen2.5-Math-7B-Instruct
#
...
#   bash run_04_Qwen_Qwen2_5-Math-7B-Instruct.sh 60 500
#
# Run from the repository root:
#   bash run_04_Qwen_Qwen2_5-Math-7B-Instruct.sh
set -euo pipefail
